...
- Add configuration, access, admission, local observation and DOM behavior tests. Native verification completed on 2026-09-22; see the desktop evolution plan for evidence and limits.
