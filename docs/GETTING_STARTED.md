...
创建一个试用目录，再告诉 Dao-Shell 可以访问哪些位置：
...
真实模型体验、默认应用打开交接和干净 Windows 环境验证仍待完成。遇到问题，可在 [Issues](https://github.com/kestiny18/Dao-Shell/issues/new/choose) 提供操作步骤和脱敏后的错误信息，不要粘贴 API Key 或个人文件内容。
