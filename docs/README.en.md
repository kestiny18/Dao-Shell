...
- [Development log](devlog/README.md) (Chinese): chronological public progress.
- [MVP discussion notes](reviews/2026-09-16-mvp-discussion.md) (Chinese): early decisions and trade-offs.

Dao-Shell is the project name. The executable and terminal command are consistently written as `daosh`.
